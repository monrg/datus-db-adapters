...
@pytest.fixture
def integration_config() -> MySQLConfig:
...
@pytest.fixture
def integration_connector(integration_config: MySQLConfig) -> Generator[MySQLConnector, None, None]:
    """Create and cleanup MySQL connector for integration tests."""
    try:
        conn = MySQLConnector(integration_config)
        yield conn
